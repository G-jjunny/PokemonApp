...
import IconBall from "../../assets/Img/icon_ball.png";
...
const DetailPage = () => {
  ...
  const getPokemonDiscription = async (id) => {
  ...
  const formatPoketmonSprites = (sprites) => {
  ...
  const formatPokemonAbilities = (abilities) => {
    return abilities
      ...
      .map((abj) => abj.ability.name.replaceAll("-", " "));
  };
